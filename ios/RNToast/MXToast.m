...
- (id)initWithText:(NSString *)text_{
    if (self = [super init]) {
        ...
        UILabel *textLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, textSize.width + 15, textSize.height + 15)];
...
+ (void)showWithText:(NSString *)text_{
    [MXToast showWithText:text_ duration:DEFAULT_DISPLAY_DURATION];
}

+ (void)showWithText:(NSString *)text_
            duration:(CGFloat)duration_{
    [MXToast hide];
    MXToast *toast = [[MXToast alloc] initWithText:text_];
...
+ (void)showWithText:(NSString *)text_
    ...
    [MXToast showWithText:text_  topOffset:topOffset_ duration:DEFAULT_DISPLAY_DURATION];
}
...
+ (void)showWithText:(NSString *)text_
    ...
    [MXToast showWithText:text_  bottomOffset:bottomOffset_ duration:DEFAULT_DISPLAY_DURATION];
}
...
+ (void)hide{
  NSLog(@"hide");
  UIView* content = [[[UIApplication sharedApplication] keyWindow] viewWithTag:9991];
  if (content) {
